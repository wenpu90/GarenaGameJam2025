...
public class KnockableObject : MonoBehaviour
{
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            KnockbackReaction(other);
        }
    }

    protected virtual void KnockbackReaction(Collider other)
    {
        ...
        npc.DOMove(knockTarget, knockbackDuration)
            .SetEase(Ease.OutQuad).OnComplete(OnKnockbackComplete);
        ...
        isKnockedBack = true;
        ScoreManager.Instance.AddScore(unitType);
    }
